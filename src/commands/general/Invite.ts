...
export = <Command>{
  ...
  async execute(interaction: CommandInteraction, client: ClientBase) {
    ...
    const regularInvite = new MessageButton()
    ...
    const noIntegrationInvite = new MessageButton()
      .setURL(noIntegrationInviteLink)
      .setLabel("No Integrated Discord Bot Role.")
      .setStyle("LINK");
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(
        `We appreciate you for inviting ${client.user.username}! Thank you for supporting the bot development!\n\n**Click on the button invite of your choice to invite the bot!**`
      )
      .setTimestamp()
