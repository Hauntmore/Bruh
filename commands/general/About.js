module.exports = {
	name: 'about',
	description: 'Look at the about of the bot.',
	...
	execute(message) {
		...
		const embed = client.makeEmbed()
			...
			.addField('**❯ Bot Owners -**', '<@!679867543066116169> <:h_mmLol:862736738136096788>\n<@!749732650209640529> <:h_foilpepe:826676615790198824>', false)
			.addField('**❯ Bot Moderators -**', '<@!783103759626534942> <:h_youwantittomovebutitwont:862552891063664680>', false)
			...
			.addField('**❯ Check out Bro Bot -**', '<@!543624467398524935> <:h_stonks:818000429094141962>\n[Bot Invite](https://discordapp.com/oauth2/authorize?client_id=543624467398524935&scope=bot&permissions=2146958591)\n[Land of Nothingness](https://discord.gg/PTrPAE6J4F)\n[Bro Bot Server](https://discord.gg/cTRAaKfCYe)', false)
			.setTimestamp();
